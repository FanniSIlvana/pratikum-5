...
<body>
	<form method="POST" action="postAct.php"> <!-- membuat form method POST -->
		<table width="400" align="center" cellpadding="2" cellspacing="2"> <!-- untuk membuat tabel -->
			...
			<tr> <!-- membuat baris pada tabel-->
				<td>
					...
					<!-- membuat input type submit dengan value login-->
					<input type="reset" name="reset" value="Reset">
					<!-- membuat input type reset dengan value Reset-->
				</td>
			</tr>
		</table>
	</form>
